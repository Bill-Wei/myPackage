	...
	<table width="95%" height="170" border="0" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<td width="200" height="101">
				<img src="images/jb_logo.jpg" width="64" hright="32" />
		...
		<tr>
			<td height="41" colspan="2" style="background-image: url(images/001.gif);FONT-FAMILY: 宋体;" align="center">
				...
				<s:if test="#session.user!=null">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<font class="font">欢迎你：${sessionScope.user.trueName}</font>
				</s:if>
				<s:if test="#session.admin!=null">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<font class="font">欢迎你：${sessionScope.admin.loginName}</font>
				</s:if>
			</td>
		</tr>
		<tr>
			...
			<td valign="top" width="80%">
				...
				<div align="left">
					...
					<s:form theme="simple" method="post" action="toShowMeal">
						<s:label value="输入菜名："></s:label><s:textfield name="meal.mealName"/>
						<!-- 通过隐藏表单域保存用户选择过得菜系编号，可通过餐品名和菜系组合查询 -->
				...
				<div style="background-color: #FFCC99;" align="right">
					<a href="shopCart.jsp"><img src="images/lcart_cn.gif" width="97" height="30"
					border="0"> </a>
				</div>
				<br>
				<table cellpadding="5" cellspacing="1" style="font-size: 12px;">
					...
					<s:iterator id="mealItem" value="#request.mealList" status="st">
						...
						<td>
						<a href="/Restrant/toShowDetails?meal.mealId=${mealItem.mealId}">
							<img src="mealimages/${mealItem.mealImage}" width="148" height="126" border="0"/>
						</a>
						</td>
						<td>
						<div>
							${mealItem.mealId }:${mealItem.mealName }<br />
							<span style="text-decoration:line-through; color:gray;">原价：人民币${mealItem.mealPrice }元
							</span>
							<br />
						...
						<a href="/Restrant/addtoshopcart?mealId=${mealItem.mealId }">
